...
public class DetailActivity extends AppCompatActivity implements
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor data) {
        ...
        mDetailBinding.extraDetails.humidity.setContentDescription(humidityString);
        ...
        mDetailBinding.extraDetails.windMeasurement.setContentDescription(windString);
        ...
        mDetailBinding.extraDetails.pressure.setContentDescription(pressureString);
